...
*/
func (a *DiskOperationsApiService) GetStorageDisksOperation(ctx context.Context, operationId string) (ListOperationsResponseV1Alpha5, *http.Response, error) {
	var (
...
func (a *DiskOperationsApiService) GetStorageDisksOperations(ctx context.Context, localVarOptionals *DiskOperationsApiGetStorageDisksOperationsOpts) (ListOperationsResponseV1Alpha5, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
