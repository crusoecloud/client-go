 ...
 * @param projectId
 * @param operationId
 * @param optional nil or *VPCSubnetOperationsApiGetNetworkingVPCSubnetsOperationOpts - Optional Parameters:
     * @param "ResourceId" (optional.String) -
     * @param "State" (optional.Interface of []string) -
@return Operation
*/

type VPCSubnetOperationsApiGetNetworkingVPCSubnetsOperationOpts struct {
	ResourceId optional.String
	State      optional.Interface
}

func (a *VPCSubnetOperationsApiService) GetNetworkingVPCSubnetsOperation(ctx context.Context, projectId string, operationId string, localVarOptionals *VPCSubnetOperationsApiGetNetworkingVPCSubnetsOperationOpts) (Operation, *http.Response, error) {
	var (
