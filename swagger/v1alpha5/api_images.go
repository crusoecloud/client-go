...
func (a *ImagesApiService) GetImage(ctx context.Context, imageId string) (Image, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/compute/images/{image_id}"
...
*/
func (a *ImagesApiService) ListImages(ctx context.Context) (ListImagesResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/compute/images"
