...
func (a *ExternalLoadBalancersApiService) CreateExternalLoadBalancer(ctx context.Context, body ExternalLoadBalancerPostRequest, projectId string) (AsyncOperationResponse, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/projects/{project_id}/networking/external-load-balancers"
...
func (a *ExternalLoadBalancersApiService) DeleteExternalLoadBalancer(ctx context.Context, projectId string, loadBalancerId string) (AsyncOperationResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{project_id}/networking/external-load-balancers/{load_balancer_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"project_id"+"}", fmt.Sprintf("%v", projectId), -1)
