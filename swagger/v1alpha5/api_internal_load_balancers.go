...
*/
func (a *InternalLoadBalancersApiService) ListLoadBalancers(ctx context.Context, projectId string) (ListLoadBalancersResponseV1Alpha5, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return AsyncOperationResponse
*/
func (a *InternalLoadBalancersApiService) PatchLoadBalancer(ctx context.Context, body LoadBalancersPatchRequestV1Alpha5, projectId string, loadBalancerId string) (AsyncOperationResponse, *http.Response, error) {
	var (
