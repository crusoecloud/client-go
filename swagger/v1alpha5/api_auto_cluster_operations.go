...
/*
AutoClusterOperationsApiService Retrieve the AutoCluster configuration for a specific cluster.
Returns the cluster&#x27;s autocluster configuration including alert handling defaults and any customer overrides.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param projectId Project ID
  - @param clusterId Cluster ID

@return AutoClusterConfigResponse
*/
func (a *AutoClusterOperationsApiService) GetAutoClusterConfig(ctx context.Context, projectId string, clusterId string) (AutoClusterConfigResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue AutoClusterConfigResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{project_id}/kubernetes/clusters/{cluster_id}/autocluster-config"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AutoClusterConfigResponse
...
/*
AutoClusterOperationsApiService Update the AutoCluster configuration for a specific cluster.
Allows setting or removing alert action overrides and configuring project reservation fallback.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
@return AutoClusterConfigResponse
*/
func (a *AutoClusterOperationsApiService) UpdateAutoClusterConfig(ctx context.Context, body UpdateAutoClusterConfigRequest, projectId string, clusterId string) (AutoClusterConfigResponse, *http.Response, error) {
	var (
