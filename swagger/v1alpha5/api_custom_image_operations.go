...
func (a *CustomImageOperationsApiService) ListCustomImagesOperations(ctx context.Context, projectId string, localVarOptionals *CustomImageOperationsApiListCustomImagesOperationsOpts) (ListOperationsResponseV1Alpha5, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
