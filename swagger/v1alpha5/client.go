...
// APIClient manages communication with the Crusoe Cloud API Gateway API vv1alpha5
...
type APIClient struct {
	...
	KubernetesAddonsApi *KubernetesAddonsApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.KubernetesAddonsApi = (*KubernetesAddonsApiService)(&c.common)
	...
	c.VPCFirewallRuleOperationsApi = (*VPCFirewallRuleOperationsApiService)(&c.common)
