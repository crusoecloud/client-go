...
type TrainingClusterNodePoolOperationsApiService service

/*
TrainingClusterNodePoolOperationsApiService Get status of a single asynchronous operation
This resource retrieves information about the status of an asynchronous operation initiated by the Training Cluster Node Pool resource. Only information about the operation specified in the path will be returned, or an HTTP 403 will be returned if the operation does not exist, was not initiated by the logged in user, or has expired.
