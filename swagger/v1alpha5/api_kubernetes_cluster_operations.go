...
func (a *KubernetesClusterOperationsApiService) ListKubernetesClustersOperations(ctx context.Context, projectId string, localVarOptionals *KubernetesClusterOperationsApiListKubernetesClustersOperationsOpts) (ListOperationsResponseV1Alpha5, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
