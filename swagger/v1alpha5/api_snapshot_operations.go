...
*/
func (a *SnapshotOperationsApiService) GetStorageSnapshotsOperation(ctx context.Context, operationId string) (ListOperationsResponseV1Alpha5, *http.Response, error) {
	var (
...
func (a *SnapshotOperationsApiService) GetStorageSnapshotsOperations(ctx context.Context, localVarOptionals *SnapshotOperationsApiGetStorageSnapshotsOperationsOpts) (ListOperationsResponseV1Alpha5, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
