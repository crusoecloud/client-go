...
*/
func (a *KubernetesNodePoolOperationsApiService) ListKubernetesNodePoolsOperations(ctx context.Context, projectId string) (ListOperationsResponseV1Alpha5, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
