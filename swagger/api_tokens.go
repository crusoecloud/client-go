...
/*
TokensApiService Creates a new token owned by the logged in user.
...
func (a *TokensApiService) CreateToken(ctx context.Context, body CreateTokenRequest) (TokensPostResponse, *http.Response, error) {
	var (
		...
		localVarReturnValue TokensPostResponse
	)
...
/*
TokensApiService Deletes an API token owned by the logged in user.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accessKey
...
func (a *TokensApiService) DeleteToken(ctx context.Context, accessKey string) (*http.Response, error) {
	...
	localVarQueryParams.Add("access_key", parameterToString(accessKey, ""))
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{"application/json"}
...
/*
TokensApiService Retrieves all active/expired API tokens for the logged in user.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return TokensGetResponse
*/
func (a *TokensApiService) GetTokens(ctx context.Context) (TokensGetResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue TokensGetResponse
	)
