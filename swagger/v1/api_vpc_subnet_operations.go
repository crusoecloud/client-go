...
/*
VPCSubnetOperationsApiService Get status of a single asynchronous operation
...
func (a *VPCSubnetOperationsApiService) GetNetworkingVPCSubnetsOperation(ctx context.Context, projectId string, operationId string) (Operation, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/projects/{project_id}/networking/vpc-subnets/operations/{operation_id}"
...
/*
VPCSubnetOperationsApiService Get status of asynchronous operations
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param projectId
 * @param optional nil or *VPCSubnetOperationsApiListNetworkingVPCSubnetsOperationsOpts - Optional Parameters:
...
func (a *VPCSubnetOperationsApiService) ListNetworkingVPCSubnetsOperations(ctx context.Context, projectId string, localVarOptionals *VPCSubnetOperationsApiListNetworkingVPCSubnetsOperationsOpts) (ListOperationsResponseV1, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{project_id}/networking/vpc-subnets/operations"
	localVarPath = strings.Replace(localVarPath, "{"+"project_id"+"}", fmt.Sprintf("%v", projectId), -1)
