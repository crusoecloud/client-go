...
*/
func (a *CustomImagesApiService) CustomImageDelete(ctx context.Context, imageId string, projectId string) (AsyncOperationResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/projects/{project_id}/compute/custom-images/{image_id}"
...
func (a *CustomImagesApiService) CustomImageEditTags(ctx context.Context, body CustomImageEditTagsRequest, imageId string, projectId string) (AsyncOperationResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{project_id}/compute/custom-images/{image_id}/edit-tags"
	localVarPath = strings.Replace(localVarPath, "{"+"image_id"+"}", fmt.Sprintf("%v", imageId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"project_id"+"}", fmt.Sprintf("%v", projectId), -1)
...
@return AsyncOperationResponse
*/
func (a *CustomImagesApiService) CustomImagePost(ctx context.Context, body CustomImagePostRequest, projectId string) (AsyncOperationResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{project_id}/compute/custom-images"
	localVarPath = strings.Replace(localVarPath, "{"+"project_id"+"}", fmt.Sprintf("%v", projectId), -1)
...
@return Image
*/
func (a *CustomImagesApiService) GetCustomImage(ctx context.Context, imageId string, projectId string) (Image, *http.Response, error) {
	var (
...
*/
func (a *CustomImagesApiService) ListCustomImages(ctx context.Context, projectId string) (ListImagesResponseV1, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ListImagesResponseV1
	)
