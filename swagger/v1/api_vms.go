...
*/
func (a *VMsApiService) BulkCreateInstance(ctx context.Context, body BulkInstancePostRequestV1, projectId string) (AsyncOperationResponse, *http.Response, error) {
	var (
...
@return AsyncOperationResponse
*/
func (a *VMsApiService) CreateInstance(ctx context.Context, body InstancesPostRequestV1, projectId string) (AsyncOperationResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
...
@return InstanceV1
*/
func (a *VMsApiService) GetInstance(ctx context.Context, projectId string, vmId string) (InstanceV1, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue InstanceV1
	)
...
@return ListTypesResponseV1
*/
func (a *VMsApiService) GetVMTypes(ctx context.Context, projectId string) (ListTypesResponseV1, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ListTypesResponseV1
	)
...
func (a *VMsApiService) ListInstances(ctx context.Context, projectId string, localVarOptionals *VMsApiListInstancesOpts) (ListInstancesResponseV1, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ListInstancesResponseV1
	)
...
@return AsyncOperationResponse
*/
func (a *VMsApiService) UpdateInstance(ctx context.Context, body InstancesPatchRequestV1, projectId string, vmId string) (AsyncOperationResponse, *http.Response, error) {
	var (
...
@return AsyncOperationResponse
*/
func (a *VMsApiService) UpdateInstanceAttachDisks(ctx context.Context, body InstancesAttachDiskPostRequestV1, projectId string, vmId string) (AsyncOperationResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
