...
*/
func (a *DisksApiService) CreateDisk(ctx context.Context, body DisksPostRequestV1, projectId string) (AsyncOperationResponse, *http.Response, error) {
	var (
...
@return DiskV1
*/
func (a *DisksApiService) GetDisk(ctx context.Context, projectId string, diskId string) (DiskV1, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue DiskV1
	)
...
func (a *DisksApiService) ListDisks(ctx context.Context, projectId string, localVarOptionals *DisksApiListDisksOpts) (ListDisksResponseV1, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ListDisksResponseV1
	)
