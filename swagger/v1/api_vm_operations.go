...
func (a *VMOperationsApiService) ListComputeVMsInstancesOperations(ctx context.Context, projectId string, localVarOptionals *VMOperationsApiListComputeVMsInstancesOperationsOpts) (ListOperationsResponseV1, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
