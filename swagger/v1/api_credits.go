...
/*
CreditsApiService Get the aggregate credit balance for the specified organization. By default only active grants are counted.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param organizationId

@return GetCreditBalanceResponse
*/
func (a *CreditsApiService) GetCreditBalance(ctx context.Context, organizationId string) (GetCreditBalanceResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue GetCreditBalanceResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/organizations/{organization_id}/billing/credit-balance"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v GetCreditBalanceResponse
