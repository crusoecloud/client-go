...
func (a *AutoClusterOperationsApiService) ListAutoClusterOperations(ctx context.Context, projectId string, localVarOptionals *AutoClusterOperationsApiListAutoClusterOperationsOpts) (ListOperationsResponseV1, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
