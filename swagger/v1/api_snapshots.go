...
*/
func (a *SnapshotsApiService) CreateDiskSnapshot(ctx context.Context, body DiskSnapshotPostRequestV1, projectId string) (AsyncOperationResponse, *http.Response, error) {
	var (
...
@return ListDiskSnapshotsResponseV1
*/
func (a *SnapshotsApiService) ListDiskSnapshots(ctx context.Context, projectId string) (ListDiskSnapshotsResponseV1, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ListDiskSnapshotsResponseV1
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ListDiskSnapshotsResponseV1
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
*/
func (a *SnapshotsApiService) RenameDiskSnapshot(ctx context.Context, body DiskSnapshotPatchRequest, projectId string, snapshotId string) (SyncOperationResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Patch")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue SyncOperationResponse
	)
