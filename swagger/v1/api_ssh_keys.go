...
@return ListSshKeysResponseV1
*/
func (a *SSHKeysApiService) GetSSHKeys(ctx context.Context) (ListSshKeysResponseV1, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ListSshKeysResponseV1
	)
