...
@return ListEntitiesResponseV1
*/
func (a *EntitiesApiService) GetOrganizations(ctx context.Context) (ListEntitiesResponseV1, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ListEntitiesResponseV1
	)
