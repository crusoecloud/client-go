...
*/
func (a *VPCFirewallRulesApiService) CreateVPCFirewallRule(ctx context.Context, body VpcFirewallRulesPostRequestV1, projectId string) (AsyncOperationResponse, *http.Response, error) {
	var (
...
@return ListVpcFirewallRulesResponseV1
*/
func (a *VPCFirewallRulesApiService) ListVPCFirewallRules(ctx context.Context, projectId string) (ListVpcFirewallRulesResponseV1, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ListVpcFirewallRulesResponseV1
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ListVpcFirewallRulesResponseV1
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
