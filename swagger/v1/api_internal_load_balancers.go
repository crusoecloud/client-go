...
*/
func (a *InternalLoadBalancersApiService) CreateLoadBalancer(ctx context.Context, body LoadBalancersPostRequest, projectId string) (AsyncOperationResponse, *http.Response, error) {
	var (
...
@return AsyncOperationResponse
*/
func (a *InternalLoadBalancersApiService) DeleteLoadBalancer(ctx context.Context, projectId string, loadBalancerId string) (AsyncOperationResponse, *http.Response, error) {
	var (
...
@return LoadBalancer
*/
func (a *InternalLoadBalancersApiService) GetLoadBalancer(ctx context.Context, projectId string, loadBalancerId string) (LoadBalancer, *http.Response, error) {
	var (
...
@return ListLoadBalancersResponseV1
*/
func (a *InternalLoadBalancersApiService) ListLoadBalancers(ctx context.Context, projectId string) (ListLoadBalancersResponseV1, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ListLoadBalancersResponseV1
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ListLoadBalancersResponseV1
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
@return AsyncOperationResponse
*/
func (a *InternalLoadBalancersApiService) PatchLoadBalancer(ctx context.Context, body LoadBalancersPatchRequestV1, projectId string, loadBalancerId string) (AsyncOperationResponse, *http.Response, error) {
	var (
