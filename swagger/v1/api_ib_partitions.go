...
@return IbPartition
*/
func (a *IBPartitionsApiService) CreateIBPartition(ctx context.Context, body IbPartitionsPostRequestV1, projectId string) (IbPartition, *http.Response, error) {
	var (
...
@return ListIbPartitionsResponseV1
*/
func (a *IBPartitionsApiService) ListIBPartitions(ctx context.Context, projectId string) (ListIbPartitionsResponseV1, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ListIbPartitionsResponseV1
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ListIbPartitionsResponseV1
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
