...
@return ListTokensResponseV1
*/
func (a *TokensApiService) GetTokens(ctx context.Context) (ListTokensResponseV1, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ListTokensResponseV1
	)
