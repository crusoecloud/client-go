...
type CustomImageOperationsApiService service

/*
CustomImageOperationsApiService Get status of a single asynchronous custom image operation
...
@return Operation
*/
func (a *CustomImageOperationsApiService) GetCustomImagesOperation(ctx context.Context, projectId string, operationId string) (Operation, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/projects/{project_id}/compute/custom-images/operations/{operation_id}"
...
/*
CustomImageOperationsApiService Get status of asynchronous operations
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param projectId
 * @param optional nil or *CustomImageOperationsApiListCustomImagesOperationsOpts - Optional Parameters:
     * @param "ResourceId" (optional.String) -
     * @param "State" (optional.Interface of []string) -
@return ListOperationsResponseV1
*/

type CustomImageOperationsApiListCustomImagesOperationsOpts struct {
	ResourceId optional.String
	State      optional.Interface
}

func (a *CustomImageOperationsApiService) ListCustomImagesOperations(ctx context.Context, projectId string, localVarOptionals *CustomImageOperationsApiListCustomImagesOperationsOpts) (ListOperationsResponseV1, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{project_id}/compute/custom-images/operations"
	localVarPath = strings.Replace(localVarPath, "{"+"project_id"+"}", fmt.Sprintf("%v", projectId), -1)
