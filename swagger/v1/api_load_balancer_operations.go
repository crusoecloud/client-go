...
func (a *LoadBalancerOperationsApiService) ListExternalLoadBalancerOperations(ctx context.Context, projectId string, localVarOptionals *LoadBalancerOperationsApiListExternalLoadBalancerOperationsOpts) (ListOperationsResponseV1, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
