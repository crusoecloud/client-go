...
*/
func (a *ProjectsApiService) CreateProject(ctx context.Context, body ProjectsPostRequest) (ProjectsPutPostResponseV1, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ProjectsPutPostResponseV1
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ProjectsPutPostResponseV1
...
func (a *ProjectsApiService) ListProjects(ctx context.Context, localVarOptionals *ProjectsApiListProjectsOpts) (ListProjectsResponseV1, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ListProjectsResponseV1
	)
...
@return ProjectsPutPostResponseV1
*/
func (a *ProjectsApiService) UpdateProject(ctx context.Context, body ProjectsPutRequest, projectId string) (ProjectsPutPostResponseV1, *http.Response, error) {
	var (
