 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param projectId
 * @param optional nil or *VPCFirewallRuleOperationsApiListNetworkingVPCFirewallRulesOperationsOpts - Optional Parameters:
...
func (a *VPCFirewallRuleOperationsApiService) ListNetworkingVPCFirewallRulesOperations(ctx context.Context, projectId string, localVarOptionals *VPCFirewallRuleOperationsApiListNetworkingVPCFirewallRulesOperationsOpts) (ListOperationsResponseV1, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
