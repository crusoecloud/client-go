...
func (a *VPCNetworkOperationsApiService) GetNetworkingVPCNetworksOperation(ctx context.Context, projectId string, operationId string) (Operation, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/projects/{project_id}/networking/vpc-networks/operations/{operation_id}"
...
func (a *VPCNetworkOperationsApiService) ListNetworkingVPCNetworksOperations(ctx context.Context, projectId string, localVarOptionals *VPCNetworkOperationsApiListNetworkingVPCNetworksOperationsOpts) (ListOperationsResponseV1, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{project_id}/networking/vpc-networks/operations"
	localVarPath = strings.Replace(localVarPath, "{"+"project_id"+"}", fmt.Sprintf("%v", projectId), -1)
